...
echo "$($PSQL "SELECT DISTINCT name FROM teams LEFT JOIN games ON teams.team_id IN (games.winner_id, games.opponent_id) WHERE round='Eighth-Final' AND year=2014 ORDER BY name")"
